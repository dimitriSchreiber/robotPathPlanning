...
function updateStartStopTriggerComboboxes()
    ...
    comboStopTrigger=sim.UI_populateCombobox(ui,13,loc,{},simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.CONVEYOR_STOP_SIGNAL_REF)),true,{{simBWF.NONE_TEXT,-1}})
    comboStartTrigger=sim.UI_populateCombobox(ui,14,loc,{},simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.CONVEYOR_START_SIGNAL_REF)),true,{{simBWF.NONE_TEXT,-1}})
end
