...
function getAvailableDropLocations(returnMap)
    ...
    local retL={}
    for i=1,#l,1 do
        local data1=sim.readCustomDataBlock(l[i],simBWF.OLDLOCATION_TAG)
...
--    exceptItems[simBWF.NONE_TEXT]=nil
    comboDropLocations[1]=sim.UI_populateCombobox(ui,501,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_DROPLOCATION1_REF)),true,{{simBWF.NONE_TEXT,-1}})
...
--    exceptItems[simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_DROPLOCATION4_REF))]=true
--    exceptItems[simBWF.NONE_TEXT]=nil
    comboDropLocations[2]=sim.UI_populateCombobox(ui,502,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_DROPLOCATION2_REF)),true,{{simBWF.NONE_TEXT,-1}})
...
--    exceptItems[simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_DROPLOCATION4_REF))]=true
--    exceptItems[simBWF.NONE_TEXT]=nil
    comboDropLocations[3]=sim.UI_populateCombobox(ui,503,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_DROPLOCATION3_REF)),true,{{simBWF.NONE_TEXT,-1}})
...
--    exceptItems[simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_DROPLOCATION3_REF))]=true
--    exceptItems[simBWF.NONE_TEXT]=nil
    comboDropLocations[4]=sim.UI_populateCombobox(ui,504,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_DROPLOCATION4_REF)),true,{{simBWF.NONE_TEXT,-1}})
end
...
function updateTrackingWindowComboboxes()
    ...
    local exceptItems={}
    comboPartTrackingWindow=sim.UI_populateCombobox(ui,20,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_PARTTRACKING1_REF)),true,{{simBWF.NONE_TEXT,-1}})

    exceptItems={}
    comboAuxPartTrackingWindow=sim.UI_populateCombobox(ui,39,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_PARTTRACKING2_REF)),true,{{simBWF.NONE_TEXT,-1}})

    exceptItems={}
    comboLocationTrackingWindow=sim.UI_populateCombobox(ui,21,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_TARGETTRACKING1_REF)),true,{{simBWF.NONE_TEXT,-1}})

    exceptItems={}
    comboAuxLocationTrackingWindow=sim.UI_populateCombobox(ui,22,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_TARGETTRACKING2_REF)),true,{{simBWF.NONE_TEXT,-1}})
end

function updateStaticWindowComboboxes()
    local loc=getAvailableStaticPartWindows()
    local exceptItems={}
    comboStaticPartWindow=sim.UI_populateCombobox(ui,505,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_STATICWINDOW1_REF)),true,{{simBWF.NONE_TEXT,-1}})
end

function updateStaticTargetWindowComboboxes()
    local loc=getAvailableStaticTargetWindows()
    local exceptItems={}
    comboStaticTargetWindow=sim.UI_populateCombobox(ui,506,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.OLDRAGNAR_STATICTARGETWINDOW1_REF)),true,{{simBWF.NONE_TEXT,-1}})
end
