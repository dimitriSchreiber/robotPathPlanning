...
function readInfo()
    local data=sim.readCustomDataBlock(model,simBWF.LIFT_TAG)
    if data then
...
function writeInfo(data)
    if data then
        sim.writeCustomDataBlock(model,simBWF.LIFT_TAG,sim.packTable(data))
    else
        sim.writeCustomDataBlock(model,simBWF.LIFT_TAG,'')
    end
end
