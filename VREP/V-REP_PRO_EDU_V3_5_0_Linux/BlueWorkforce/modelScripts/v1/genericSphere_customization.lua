...
function readInfo()
    local data=sim.readCustomDataBlock(model,simBWF.SPHERE_PART_TAG)
    if data then
...
function writeInfo(data)
    if data then
        sim.writeCustomDataBlock(model,simBWF.SPHERE_PART_TAG,sim.packTable(data))
    else
        sim.writeCustomDataBlock(model,simBWF.SPHERE_PART_TAG,'')
    end
end
