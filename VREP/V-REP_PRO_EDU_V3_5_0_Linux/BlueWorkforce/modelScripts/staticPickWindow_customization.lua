...
function createDlg()
    if (not ui) and simBWF.canOpenPropertyDialog() then
        ...
        comboSensor=sim.UI_populateCombobox(ui,23,sens,{},simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.STATICPICKWINDOW_SENSOR_REF)),true,{{simBWF.NONE_TEXT,-1}})
