...
getSensorState=function()
    if sensorHandle>=0 then
        ...
        local data=sim.readCustomDataBlock(sensorHandle,simBWF.OLDSTATICPLACEWINDOW_TAG)
        if data then
            data=sim.unpackTable(data)
            return data['triggerState']
        end
                ...
                if dat then
                    ...
                    if not hmitems then
                       ...
                       -- Labels:
                        ...
                        sim.writeCustomDataBlock(h,simBWF.PART_TAG,sim.packTable(data))
                        ...
                        data=sim.unpackTable(data)
                        data['instanciated']=true
                        sim.writeCustomDataBlock(h,simBWF.PART_TAG,'')
                        ...
                        for cci=1,#itemsOnBase,1 do
                            ...
                            data['instanciated']=true
                            sim.writeCustomDataBlock(iih,simBWF.PART_TAG,sim.packTable(data))
