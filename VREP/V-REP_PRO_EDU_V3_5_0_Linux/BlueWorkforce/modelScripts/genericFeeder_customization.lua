...
function updateStartStopTriggerComboboxes()
    ...
    comboStopTrigger=sim.UI_populateCombobox(ui1,100,loc,{},simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.FEEDER_STOPSIGNAL_REF)),true,{{simBWF.NONE_TEXT,-1}})
    comboStartTrigger=sim.UI_populateCombobox(ui1,101,loc,{},simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.FEEDER_STARTSIGNAL_REF)),true,{{simBWF.NONE_TEXT,-1}})
end
...
function createDlg1()
    ...
    <tab title="Configuration" layout="form" id="54">
        ...
        comboConveyor=sim.UI_populateCombobox(ui1,998,loc,{},simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.FEEDER_CONVEYOR_REF)),true,{{simBWF.NONE_TEXT,-1}})
        loc=getAvailableSensors()
        comboSensor=sim.UI_populateCombobox(ui1,999,loc,{},simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.FEEDER_SENSOR_REF)),true,{{simBWF.NONE_TEXT,-1}})
