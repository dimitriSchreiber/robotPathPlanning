...
function readInfo()
    local data=sim.readCustomDataBlock(model,simBWF.MULTIFEEDER_TAG)
    if data then
...
function writeInfo(data)
    if data then
        sim.writeCustomDataBlock(model,simBWF.MULTIFEEDER_TAG,sim.packTable(data))
    else
        sim.writeCustomDataBlock(model,simBWF.MULTIFEEDER_TAG,'')
    end
end
