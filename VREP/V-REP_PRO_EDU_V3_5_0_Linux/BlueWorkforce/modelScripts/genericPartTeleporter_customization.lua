...
function createDlg()
    ...
    <tab title="Colors" layout="form">
        ...
        comboDestination=sim.UI_populateCombobox(ui,12,loc,exceptItems,simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.TELEPORTER_DESTINATION_REF)),true,{{simBWF.NONE_TEXT,-1}})
